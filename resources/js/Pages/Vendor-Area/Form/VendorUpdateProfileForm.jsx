...
export default function VendorDashboard({vendor_details , vendor_board}) {
    ...
    const [vendorType, setVendorType] = useState(vendor_details.vendor_type); 
    const [companyType, setCompanyType] = useState(vendor_details.vendor_company_type); 
    const [boardDirectors, setBoardDirectors] = useState(vendor_board); 
    ...
    const handleRemoveBoardDirector = (id) => {
        const director = boardDirectors.find(d => d.id === id);
        // only persisted rows have a real UUID id from the database; new ones use Date.now()
        if (director && typeof director.id === 'string') {
            destroy(route('vendor.delete-board-member', id), {
                preserveScroll: true,
                onSuccess: () => {
                    setBoardDirectors(prev => prev.filter(d => d.id !== id));
                },
            });
        } else {
            setBoardDirectors(prev => prev.filter(d => d.id !== id));
    ...
    const { data, setData, post, delete: destroy, processing, errors, reset } = useForm({
            ...
            vendor_id: vendor_details.vendor_account_id,
            vendor_email: vendor_details.vendor_email || '',
            vendor_type: vendor_details.vendor_type,
            vendor_company_type: vendor_details.vendor_company_type || '',
            vendor_id_num: vendor_details.vendor_id_num,
            vendor_id_num_2: vendor_details.vendor_id_num_2 || '',
            vendor_name: vendor_details.vendor_name,
            vendor_contact_person: vendor_details.vendor_contact_person || '',
            vendor_contact_person_phone: vendor_details.vendor_contact_person_phone || '',
            vendor_contact_person_designation: vendor_details.vendor_contact_person_designation ||'',
            vendor_contact_person_email: vendor_details.vendor_contact_person_email || '',
            vendor_phone: vendor_details.vendor_phone || '',
            vendor_address: vendor_details.vendor_address || '',
            // vendor_bumiputera_status: '',
            vendor_business_experience_year: vendor_details.vendor_business_experience_year || '',
            vendor_business_experience_month: vendor_details.vendor_business_experience_month || '',
            vendor_website: vendor_details.vendor_website || '',
            vendor_tax_identification_num: vendor_details.vendor_tax_identification_num || '',
            vendor_sst_number: vendor_details.vendor_sst_number || '',
            vendor_establishment_date: vendor_details.vendor_establishment_date || '',
            vendor_current_establishment_cert_expiry_date: vendor_details.vendor_current_establishment_cert_expiry_date || '',
            vendor_capital_1: vendor_details.vendor_capital_1 || '',
            vendor_capital_2: vendor_details.vendor_capital_2 || '',
            vendor_bumiputera_ownership_percent: vendor_details.vendor_bumiputera_ownership_percent || '',
            vendor_non_bumiputera_ownership_percent: vendor_details.vendor_non_bumiputera_ownership_percent || '',
            vendor_bank_entity_registration_num: vendor_details.vendor_bank_entity_registration_num || '',
            vendor_bank_account_statement_address: vendor_details.vendor_bank_account_statement_address ||  '',
            vendor_bank_name: vendor_details.vendor_bank_name || '',
            vendor_bank_account_number: vendor_details.vendor_bank_account_number || '',
            vendor_MOF_reg_num: vendor_details.vendor_MOF_reg_num || '',
            vendor_MOF_start_date: vendor_details.vendor_MOF_start_date || '',
            vendor_MOF_expiry_date: vendor_details.vendor_MOF_expiry_date || '',
            vendor_MOF_attachment_address: vendor_details.vendor_MOF_attachment_address || '',
            vendor_SSM_start_date: vendor_details.vendor_SSM_start_date || '',
            vendor_SSM_expiry_date: vendor_details.vendor_SSM_expiry_date || '',
            vendor_SSM_attachment_address: vendor_details.vendor_SSM_attachment_address || '',
            vendor_PKK_reg_num: vendor_details.vendor_PKK_reg_num || '',
            vendor_PKK_start_date: vendor_details.vendor_PKK_start_date || '',
            vendor_PKK_end_date: vendor_details.vendor_PKK_end_date || '',
            vendor_PKK_class: vendor_details.vendor_PKK_class || '',
            vendor_PKK_head: vendor_details.vendor_PKK_head || '',
            vendor_PKK_attachment_address: vendor_details.vendor_PKK_attachment_address || '',
            vendor_CIDB_reg_num: vendor_details.vendor_CIDB_reg_num || '',
            vendor_CIDB_start_date: vendor_details.vendor_CIDB_start_date || '',
            vendor_CIDB_end_date: vendor_details.vendor_CIDB_end_date || '',
            vendor_CIDB_B_cat_grade: vendor_details.vendor_CIDB_B_cat_grade || '',
            vendor_CIDB_CE_cat_grade: vendor_details.vendor_CIDB_CE_cat_grade || '',
            vendor_CIDB_ME_cat_grade: vendor_details.vendor_CIDB_ME_cat_grade || '',
            vendor_CIDB_attachment_address: vendor_details.vendor_CIDB_attachment_address || '',
            vendor_MPOB_license_num: vendor_details.vendor_MPOB_license_num || '',
            vendor_MPOB_start_date: vendor_details.vendor_MPOB_start_date || '',
            vendor_MPOB_end_date: vendor_details.vendor_MPOB_end_date || '',
            vendor_MPOB_license_category: vendor_details.vendor_MPOB_license_category || '',
            vendor_MPOB_attachment_address: vendor_details.vendor_MPOB_attachment_address || '',
    });
    ...
    useEffect(() => {
        if (shouldSubmit) {
            ...
            post(route('vendor.update-profile.save'), {
                ...data
            },
            {
                preserveScroll: true,
    ...
    return (
        <VendorAuthenticatedLayout
            header={
            <div className='flex'>  
            <Link href="/vendor" className='mr-2'><ChevronLeft/></Link>
                <h2 className="text-xl font-semibold leading-tight text-gray-800">
                    Kemaskini Profail Vendor
                </h2>
            </div>
                                    ...
                                    <div className="grid flex-1 gap-2 md:grid-cols-1 my-2">
                                        <div className=''>
                                            ...
                                            <FileUploadField
                                                ...
                                                accept=".pdf"
                                                maxSize={2}
                                                initialPath={vendor_details.vendor_SSM_attachment_address}
                                        ...
                                        <div className="grid flex-1 gap-2 md:grid-cols-3 my-2">
                                            ...
                                            <div className=''>
                                                ...
                                                <FileUploadField
                                                    ...
                                                    accept=".pdf"
                                                    maxSize={2}
                                                    initialPath={vendor_details.vendor_bank_account_statement_address}
                                                    onUploaded={(path) => setData('vendor_bank_account_statement_address', path)}
                                                    error={errors.vendor_bank_account_statement_address}
                                                />
                                            </div>

                                            <div className=' p-1.5 rounded-lg bg-green-200 text-sm'>
                                                Sila muatnaik Penyata Akaun Bank terkini.
                                            </div>
                                        </div>       
                                            ...
                                            <div className="grid flex-1 gap-2 md:grid-cols-4 my-2">
                                                ...
                                                <div className=''>
                                                    ...
                                                    <FileUploadField
                                                        ...
                                                        accept=".pdf"
                                                        maxSize={2}
                                                        initialPath={vendor_details.vendor_MOF_attachment_address}
                                            ...
                                            <div className="grid flex-1 gap-2 md:grid-cols-4 my-2">
                                                ...
                                                <div className=''>
                                                    ...
                                                    <FileUploadField
                                                        ...
                                                        accept=".pdf"
                                                        maxSize={5}
                                                        initialPath={vendor_details.vendor_PKK_attachment_address}
                                            ...
                                            <div className="grid flex-1 gap-2 md:grid-cols-4 my-2">
                                                ...
                                                <div className=''>
                                                    ...
                                                    <FileUploadField
                                                        ...
                                                        accept=".pdf"
                                                        maxSize={5}
                                                        initialPath={vendor_details.vendor_CIDB_attachment_address}
                                            ...
                                            <div className="grid flex-1 gap-2 md:grid-cols-4 my-2">
                                                ...
                                                <div className=''>
                                                    ...
                                                    <FileUploadField
                                                        ...
                                                        accept=".pdf"
                                                        maxSize={5}
                                                        initialPath={vendor_details.vendor_MPOB_attachment_address}
                            ...
                            {currentPart === 5 && (
                                <div>
                                    ...
                                    <div className='text-sm'>
                                        Sila semak kembali semua maklumat yang telah dimasukkan sebelum menyimpan kemaskini borang profil ini.
                                    </div>
                                    ...
                                    <div className='text-sm border rounded-xl p-2'>
                                        ...
                                        <p>Jika anda berpuas hati, anda boleh menyimpan kemaskini borang profil ini dengan menekan butang <b>"Simpan Kemaskini"</b>.</p>
                                        <p>Sila ambil maklum bahawa dengan menyimpan kemaskini ini, Perakuan Pendaftaran Vendor anda akan <b><u>terbatal dan perlu dimohon semula.</u></b></p>
                                    </div>
