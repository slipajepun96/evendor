                    ...
                    <div className='bg-white overflow-hidden shadow-sm sm:rounded-lg p-3 mt-4'>
                        ...
                        <div className='grid flex-1 gap-2 md:grid-cols-3 my-2'>
                            ...
                            <div className=''>
                                ...
                                {parsedSnapshot['is_active'] === 0 && (
                                    <p className='inline-block bg-amber-300 border-amber-700 text-gray-600 font-bold text-xs uppercase px-1 py-0.5 rounded-md'>Tidak Aktif</p>
                                )}
                                {parsedSnapshot['is_active'] === 1 && (
                                    <p className='inline-block bg-lime-300 border-lime-500 text-gray-600 font-bold text-xs uppercase px-1 py-0.5 rounded-sm'>Aktif</p>
                                )}
                            </div>
                            <div className=''>
                                <InputLabel
                                    ...
                                    value={
                                        <>
                                            Tarikh & Masa Perakuan Diluluskan
                                        </>
                                    }
                                />
                                <ValueView value={formatDateTime(vendor.created_at)} />
                            </div>
                        </div>
